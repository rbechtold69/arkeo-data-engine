...
const KNOWN_PROVIDERS = {
  ...
  // Red_5 Pro (Randy's Keplr wallet) - 1 service, ONLINE
  ...
  // Red_5 (provider-automation key) - 1 service, ONLINE
  'arkeopub1addwnpepq2vn90jnf4tz9dylcujr5fwt55vzg07ufr30sjtsja77gwvy83wyxfck9lj': {
    name: 'Red_5',
    description: 'Arkeo validator and data provider',
    website: 'https://arkeo.network',
    location: 'Americas',
  },
